...
exports.getDistances = catchAsync(async function (req, res, next) {
  ...
  const distances = await Tour.aggregate([
    {
      // it should be first stage of aggregation pipeline

      // if you have more than one geospatial index then you have specifiy the key on which calculation should going to perfrom
      $geoNear: {
        near: {
          type: 'Point',
